...
$data = $app_data['SUPPLIER']['GULA_MERAH'][$data_id];
?>
<div class="col-md-8">
    <form method="POST" action="" class="form-horizontal" id="input-form">
        <div class="panel">
            ...
            <div class="panel-footer text-right">
                ...
                <a href="<?php echo base_url(sprintf('manufaktur.php?task=order&obj=gmerah&id=%s', $data['ID'])) ?>" class="btn btn-success">Order</a>
            </div>
        </div>
    </form>
</div>