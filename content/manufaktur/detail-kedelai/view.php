...
$data = $app_data['SUPPLIER']['KEDELAI_HITAM'][$data_id];
?>
<div class="col-md-8">
    <form method="POST" action="" class="form-horizontal" id="input-form">
        <div class="panel">
            ...
            <div class="panel-footer text-right">
                ...
                <a href="<?php echo base_url(sprintf('manufaktur.php?task=order&obj=kedelai&id=%s', $data['ID'])) ?>" class="btn btn-success">Order</a>
            </div>
        </div>
    </form>
</div>