        ...
        <div class="panel panel-visible" id="spy2">
            ...
            <div class="panel-body pn">
                <table class="table table-bordered table-hover" id="dataTables" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    <?php
                    for ( $i = 0; $i < count($app_data['SUPPLIER']['PLASTIK']); $i++ ) {
                        $data = $app_data['SUPPLIER']['PLASTIK'][sprintf("SPP%03d", $i + 1)];
                        ?>
                        <tr>
                            ...
                            <td align="center">
                                <a href="<?php echo base_url(sprintf('manufaktur.php?task=detail&obj=plastik&id=%s', $data['ID'])) ?>" class="label label-primary">Detail</a>
                                <a href="<?php echo base_url(sprintf('manufaktur.php?task=order&obj=plastik&id=%s', $data['ID'])) ?>" class="label label-success">Order</a>
                            </td>
                        </tr>
                        <?php
                    }
